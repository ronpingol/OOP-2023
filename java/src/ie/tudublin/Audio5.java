...
public class Audio5 extends PApplet {
  ...
  public void draw() {
    ...
    camera(sin(cameraAngle) * width / 2, cos(cameraAngle) * height / 2, height / 2, width / 2, height / 2, -200, 0, 1, 0);
    cameraAngle += map(fft.getBand(0), 0, 255, -0.05f, 0.05f);
